export const CATEGORIES = [
  ...
  { id: "LangGraph",      name: "LangGraph",                    icon: "🕸️" },
  ...
  { id: "Databases",      name: "Databases & Storage Systems",  icon: "🗄️" },
  { id: "Security",       name: "Security & Cryptography",      icon: "🔒" },
  { id: "CS Fundamentals",name: "CS Fundamentals",              icon: "💡" },
  { id: "Soft Skills",    name: "Soft Skills & Leadership",     icon: "🤝" }
];
...
const ADDED_CHAPTERS = [
  ...
  // Java
  { id: "java-fundamentals", title: "Java Fundamentals — Syntax, OOP Basics & JVM Overview", category: "Java", complexity: "Easy", tags: ["java", "oop", "jvm", "classes", "interfaces"], description: "Cover core Java syntax, the four OOP pillars (encapsulation, inheritance, polymorphism, abstraction), and how the JVM compiles and runs bytecode." },
  { id: "java-collections", title: "Java Collections Framework — List, Set, Map, Queue", category: "Java", complexity: "Medium", tags: ["collections", "arraylist", "hashmap", "treemap", "linkedlist", "comparator"], description: "Master the Collections Framework hierarchy: List/Set/Map/Queue implementations, when to use ArrayList vs LinkedList, HashMap vs TreeMap, and custom Comparators." },
  { id: "java-generics", title: "Java Generics & Type Bounds", category: "Java", complexity: "Medium", tags: ["generics", "type-erasure", "bounded-types", "wildcards", "pecs"], description: "Write type-safe reusable code with Java generics: bounded type parameters, wildcards (? extends/super), type erasure, and the PECS (Producer Extends, Consumer Super) principle." },
  { id: "java-streams", title: "Java Streams API & Functional Interfaces (Lambdas)", category: "Java", complexity: "Medium", tags: ["streams", "lambda", "functional-interface", "optional", "collectors"], description: "Process collections declaratively with the Streams API: map/filter/reduce pipelines, lambda expressions, functional interfaces, Optional, and Collectors for grouping/aggregation." },
  { id: "java-concurrency", title: "Java Concurrency — Threads, Executors, Locks", category: "Java", complexity: "Hard", tags: ["threads", "executorservice", "synchronized", "reentrantlock", "concurrenthashmap", "completablefuture"], description: "Build concurrent Java applications: thread lifecycle, ExecutorService thread pools, synchronized blocks vs ReentrantLock, thread-safe collections, and CompletableFuture async pipelines." },
  { id: "java-jvm-memory", title: "JVM Memory Model & Garbage Collection", category: "Java", complexity: "Hard", tags: ["jvm", "heap", "stack", "garbage-collection", "g1gc", "memory-leak"], description: "Understand JVM memory regions (heap, stack, metaspace), generational garbage collection (Young/Old Gen), G1GC internals, and diagnosing memory leaks with heap dumps." },
  { id: "java-exceptions", title: "Exception Handling — Checked vs Unchecked, Try-With-Resources", category: "Java", complexity: "Easy", tags: ["exceptions", "checked-exceptions", "try-with-resources", "custom-exceptions", "finally"], description: "Design robust error handling: checked vs unchecked exceptions, custom exception hierarchies, try-with-resources for AutoCloseable, and best practices for exception propagation." },
  { id: "java-io-nio", title: "Java I/O & NIO — Streams, Buffers, Channels", category: "Java", complexity: "Medium", tags: ["io", "nio", "buffers", "channels", "file-io", "serialization"], description: "Read/write data with classic I/O streams vs modern NIO buffers and channels. Cover file I/O, serialization, and non-blocking I/O for high-throughput applications." },
  { id: "java-modern-features", title: "Modern Java — Records, Sealed Classes, Pattern Matching (17+)", category: "Java", complexity: "Medium", tags: ["records", "sealed-classes", "pattern-matching", "switch-expressions", "var"], description: "Adopt modern Java features: records for immutable data carriers, sealed classes for restricted hierarchies, pattern matching in switch expressions, and local variable type inference (var)." },
  { id: "java-testing", title: "Testing in Java — JUnit 5 & Mockito", category: "Java", complexity: "Medium", tags: ["junit5", "mockito", "unit-testing", "mocking", "test-lifecycle", "parameterized-tests"], description: "Write maintainable Java tests with JUnit 5: annotations, parameterized tests, and lifecycle hooks. Mock dependencies with Mockito and follow the Arrange-Act-Assert pattern." },

  // JavaScript
  { id: "js-fundamentals", title: "JavaScript Fundamentals — Scope, Hoisting, Closures", category: "JavaScript", complexity: "Easy", tags: ["scope", "hoisting", "closures", "var-let-const", "temporal-dead-zone"], description: "Master core JS semantics: function vs block scope, hoisting behavior, the temporal dead zone, and how closures capture lexical scope for data privacy and factory functions." },
  { id: "js-async", title: "Asynchronous JavaScript — Promises, Async/Await, Event Loop", category: "JavaScript", complexity: "Medium", tags: ["promises", "async-await", "event-loop", "callbacks", "microtasks"], description: "Handle async operations with callbacks, Promises, and async/await. Understand the event loop, call stack, and how microtasks (Promises) are prioritized over macrotasks (setTimeout)." },
  { id: "js-prototypes", title: "Prototypes & Prototypal Inheritance", category: "JavaScript", complexity: "Medium", tags: ["prototype", "prototype-chain", "__proto__", "class-syntax", "inheritance"], description: "Understand JavaScript's prototype-based inheritance model: the prototype chain, Object.create, and how ES6 class syntax is syntactic sugar over prototypal inheritance." },
  { id: "js-this-binding", title: "Understanding `this`, call/apply/bind & Arrow Functions", category: "JavaScript", complexity: "Medium", tags: ["this", "call", "apply", "bind", "arrow-functions", "context"], description: "Demystify `this` binding rules: implicit, explicit, new, and default binding. Learn call/apply/bind for explicit context control and how arrow functions inherit lexical `this`." },
  { id: "js-es6-plus", title: "Modern ES6+ Features — Destructuring, Spread, Modules", category: "JavaScript", complexity: "Easy", tags: ["destructuring", "spread-operator", "es-modules", "template-literals", "optional-chaining"], description: "Use modern ES6+ syntax productively: destructuring assignment, spread/rest operators, ES modules (import/export), template literals, and optional chaining/nullish coalescing." },
  { id: "js-array-methods", title: "Array & Object Methods — map/filter/reduce & Immutability", category: "JavaScript", complexity: "Easy", tags: ["map", "filter", "reduce", "immutability", "array-methods", "object-methods"], description: "Master functional array methods (map, filter, reduce, find, some/every) and immutable update patterns for objects/arrays without mutating state directly." },
  { id: "js-event-loop-deep", title: "Event Loop, Microtasks & Macrotasks Deep Dive", category: "JavaScript", complexity: "Hard", tags: ["event-loop", "microtask-queue", "macrotask-queue", "settimeout", "requestanimationframe"], description: "Go deep into the JS runtime: call stack, Web APIs, microtask queue (Promises, queueMicrotask) vs macrotask queue (setTimeout, I/O), and rendering timing with requestAnimationFrame." },
  { id: "js-design-patterns", title: "JavaScript Design Patterns — Module, Singleton, Observer", category: "JavaScript", complexity: "Medium", tags: ["module-pattern", "singleton", "observer-pattern", "factory-pattern", "iife"], description: "Apply classic design patterns in idiomatic JavaScript: the module pattern (IIFEs), Singleton, Observer/PubSub for event-driven code, and Factory functions." },
  { id: "js-error-handling", title: "Error Handling & Debugging in JavaScript", category: "JavaScript", complexity: "Easy", tags: ["try-catch", "custom-errors", "error-boundaries", "debugging", "stack-trace"], description: "Handle errors gracefully with try/catch/finally, custom Error subclasses, and async error handling. Use browser DevTools and stack traces to debug effectively." },
  { id: "js-performance", title: "JavaScript Performance — Memory Leaks & Optimization", category: "JavaScript", complexity: "Hard", tags: ["memory-leaks", "garbage-collection", "debouncing", "throttling", "performance-profiling"], description: "Diagnose memory leaks (detached DOM nodes, stale closures), understand V8 garbage collection, and optimize hot paths with debouncing, throttling, and profiling tools." },

  // Python
  { id: "py-fundamentals", title: "Python Fundamentals — Syntax, Data Types & Mutability", category: "Python", complexity: "Easy", tags: ["python", "data-types", "mutability", "duck-typing", "pep8"], description: "Cover Python core syntax and semantics: dynamic/duck typing, mutable vs immutable types, variable scoping (LEGB), and idiomatic PEP 8 style." },
  { id: "py-data-structures", title: "Python Data Structures — Lists, Dicts, Sets, Tuples", category: "Python", complexity: "Easy", tags: ["lists", "dictionaries", "sets", "tuples", "slicing"], description: "Choose the right built-in data structure: list/tuple ordering & mutability, dict hashing internals, set operations, and slicing syntax for sequences." },
  { id: "py-oop", title: "Python OOP — Classes, Inheritance, Dunder Methods", category: "Python", complexity: "Medium", tags: ["classes", "inheritance", "dunder-methods", "mro", "abc"], description: "Design Python classes with inheritance, method resolution order (MRO) for multiple inheritance, dunder/magic methods (__init__, __repr__, __eq__), and abstract base classes." },
  { id: "py-comprehensions-generators", title: "Comprehensions, Generators & Iterators", category: "Python", complexity: "Medium", tags: ["list-comprehension", "generators", "yield", "iterators", "lazy-evaluation"], description: "Write Pythonic, memory-efficient code with list/dict/set comprehensions, generator functions (yield) for lazy evaluation, and the iterator protocol (__iter__/__next__)." },
  { id: "py-decorators-context", title: "Decorators, Context Managers & Closures", category: "Python", complexity: "Medium", tags: ["decorators", "context-managers", "closures", "with-statement", "functools"], description: "Extend function/class behavior with decorators (functools.wraps), manage resources with context managers (with statement, __enter__/__exit__), and understand closures." },
  { id: "py-async", title: "Async Python — asyncio, Coroutines & Event Loop", category: "Python", complexity: "Hard", tags: ["asyncio", "coroutines", "async-await", "event-loop", "tasks"], description: "Write concurrent I/O-bound code with asyncio: coroutines, async/await syntax, the event loop, Tasks, and gathering concurrent operations without threads." },
  { id: "py-gil-concurrency", title: "GIL, Threading & Multiprocessing", category: "Python", complexity: "Hard", tags: ["gil", "threading", "multiprocessing", "concurrent-futures", "cpu-bound"], description: "Understand the Global Interpreter Lock's impact on threading, when to use threading (I/O-bound) vs multiprocessing (CPU-bound), and the concurrent.futures API." },
  { id: "py-typing", title: "Type Hints & Static Typing with mypy", category: "Python", complexity: "Medium", tags: ["type-hints", "mypy", "typing-module", "generics", "protocol"], description: "Add static type checking to Python with type hints, the typing module (Optional, Union, Generic, Protocol), and catching type errors early with mypy." },
  { id: "py-testing", title: "Testing in Python — pytest, Mocking, Fixtures", category: "Python", complexity: "Medium", tags: ["pytest", "fixtures", "mocking", "parametrize", "unittest"], description: "Write maintainable Python tests with pytest: fixtures for setup/teardown, parametrized tests, mocking external dependencies with unittest.mock, and test coverage." },
  { id: "py-packaging", title: "Python Packaging, Virtual Envs & Dependency Management", category: "Python", complexity: "Easy", tags: ["venv", "pip", "poetry", "requirements", "packaging"], description: "Manage Python project dependencies with virtual environments (venv), pip/Poetry, pyproject.toml, and best practices for reproducible, isolated environments." },

  // React
  { id: "react-fundamentals", title: "React Fundamentals — Components, Props & JSX", category: "React", complexity: "Easy", tags: ["react", "components", "props", "jsx", "virtual-dom"], description: "Learn React's component model: functional components, props flow, JSX compilation, and how the virtual DOM diffing algorithm minimizes real DOM updates." },
  { id: "react-hooks-rules", title: "React Hooks — Rules, Common Pitfalls & Custom Hooks", category: "React", complexity: "Medium", tags: ["hooks", "useeffect", "rules-of-hooks", "custom-hooks", "dependency-array"], description: "Apply the Rules of Hooks correctly, avoid common useEffect pitfalls (stale closures, missing dependencies), and extract reusable logic into custom hooks." },
  { id: "react-state-management", title: "React State Management — Context, Redux Toolkit, Zustand", category: "React", complexity: "Medium", tags: ["context-api", "redux-toolkit", "zustand", "global-state", "state-colocation"], description: "Choose the right state management approach: local state, Context API for shared state, Redux Toolkit for complex apps, and lightweight alternatives like Zustand." },
  { id: "react-performance", title: "React Performance — memo, useMemo, useCallback, Profiler", category: "React", complexity: "Hard", tags: ["react-memo", "usememo", "usecallback", "profiler", "re-renders"], description: "Prevent unnecessary re-renders with React.memo, useMemo, and useCallback. Identify performance bottlenecks using the React DevTools Profiler." },
  { id: "react-router", title: "React Router — Routing, Nested Routes & Data Loading", category: "React", complexity: "Medium", tags: ["react-router", "nested-routes", "loaders", "dynamic-routing", "navigation"], description: "Build client-side routing with React Router: nested routes, dynamic segments, data loaders/actions, and programmatic navigation." },
  { id: "react-forms", title: "Forms in React — Controlled Components & Validation", category: "React", complexity: "Medium", tags: ["controlled-components", "uncontrolled-components", "form-validation", "react-hook-form"], description: "Build robust forms with controlled vs uncontrolled inputs, client-side validation strategies, and efficient form libraries like React Hook Form." },
  { id: "react-testing", title: "Testing React Apps — React Testing Library & Jest", category: "React", complexity: "Medium", tags: ["react-testing-library", "jest", "user-event", "mocking-apis", "snapshot-testing"], description: "Write user-centric React tests with Testing Library queries and userEvent, mock API calls, and understand when (and when not) to use snapshot testing." },
  { id: "react-server-components", title: "React Server Components & Suspense", category: "React", complexity: "Hard", tags: ["server-components", "suspense", "streaming-ssr", "use-hook", "hydration"], description: "Understand React Server Components vs Client Components, streaming SSR with Suspense boundaries, and how hydration reconciles server-rendered markup." },
  { id: "react-patterns", title: "React Design Patterns — HOC, Render Props, Compound Components", category: "React", complexity: "Hard", tags: ["higher-order-components", "render-props", "compound-components", "composition"], description: "Compare classic component composition patterns: Higher-Order Components, Render Props, and Compound Components — and why hooks replaced most HOC/render-prop use cases." },
  { id: "react-nextjs", title: "Next.js Fundamentals — App Router & SSR/SSG", category: "React", complexity: "Medium", tags: ["nextjs", "app-router", "ssr", "ssg", "isr", "file-based-routing"], description: "Build production React apps with Next.js: file-based App Router, choosing between SSR/SSG/ISR rendering strategies, and API routes." },

  // Angular
  { id: "angular-fundamentals", title: "Angular Fundamentals — Components, Modules & Templates", category: "Angular", complexity: "Easy", tags: ["angular", "components", "ngmodule", "templates", "data-binding"], description: "Learn Angular's component-based architecture: NgModules, component decorators, template syntax, and one-way/two-way data binding." },
  { id: "angular-di", title: "Dependency Injection in Angular", category: "Angular", complexity: "Medium", tags: ["dependency-injection", "providers", "injectable", "injection-tokens", "hierarchical-injectors"], description: "Master Angular's hierarchical dependency injection system: @Injectable services, provider scopes, injection tokens, and singleton vs per-component instances." },
  { id: "angular-rxjs", title: "RxJS & Observables in Angular", category: "Angular", complexity: "Hard", tags: ["rxjs", "observables", "operators", "subjects", "async-pipe"], description: "Handle async data streams with RxJS: Observables vs Promises, common operators (map, switchMap, debounceTime), Subjects, and the async pipe for template subscriptions." },
  { id: "angular-forms", title: "Angular Forms — Template-Driven & Reactive Forms", category: "Angular", complexity: "Medium", tags: ["reactive-forms", "template-driven-forms", "formcontrol", "validators", "form-arrays"], description: "Compare template-driven vs reactive forms, build typed FormGroups/FormControls, apply built-in and custom Validators, and manage dynamic FormArrays." },
  { id: "angular-routing", title: "Angular Router — Guards, Lazy Loading & Resolvers", category: "Angular", complexity: "Medium", tags: ["angular-router", "route-guards", "lazy-loading", "resolvers", "child-routes"], description: "Configure Angular routing: CanActivate/CanDeactivate guards for auth, lazy-loaded feature modules, route resolvers for pre-fetching data, and child routes." },
  { id: "angular-ngrx", title: "Services & State Management (NgRx)", category: "Angular", complexity: "Hard", tags: ["ngrx", "redux-pattern", "actions", "reducers", "effects", "selectors"], description: "Manage complex application state with NgRx: actions, reducers, effects for side effects, memoized selectors, and the store as a single source of truth." },
  { id: "angular-change-detection", title: "Change Detection Strategy & Zone.js", category: "Angular", complexity: "Hard", tags: ["change-detection", "zone-js", "onpush", "immutability", "performance"], description: "Understand how Zone.js triggers Angular's change detection, the difference between Default and OnPush strategies, and immutability patterns for OnPush performance gains." },
  { id: "angular-directives-pipes", title: "Directives & Pipes — Custom Behavior", category: "Angular", complexity: "Medium", tags: ["structural-directives", "attribute-directives", "custom-pipes", "pure-pipes"], description: "Build custom structural and attribute directives, and pure vs impure pipes for transforming template data efficiently." },
  { id: "angular-testing", title: "Testing Angular — Jasmine, Karma & TestBed", category: "Angular", complexity: "Medium", tags: ["jasmine", "karma", "testbed", "component-testing", "spies"], description: "Test Angular components and services using Jasmine specs, the TestBed for configuring test modules, spies for mocking dependencies, and Karma as the test runner." },
  { id: "angular-signals", title: "Angular Signals & Standalone Components (Modern Angular)", category: "Angular", complexity: "Medium", tags: ["signals", "standalone-components", "computed", "effect", "modern-angular"], description: "Adopt modern Angular primitives: fine-grained reactivity with Signals, computed/effect functions, and standalone components that remove the need for NgModules." },

  // Spring Boot
  { id: "spring-fundamentals", title: "Spring Boot Fundamentals — Auto-Configuration & Starters", category: "Spring Boot", complexity: "Easy", tags: ["spring-boot", "auto-configuration", "starters", "application-yml", "embedded-server"], description: "Understand how Spring Boot's auto-configuration and starter dependencies eliminate boilerplate, configure apps via application.yml/properties, and run with an embedded server." },
  { id: "spring-di", title: "Spring Dependency Injection & Bean Lifecycle", category: "Spring Boot", complexity: "Medium", tags: ["dependency-injection", "beans", "component-scan", "bean-scopes", "lifecycle-callbacks"], description: "Master the Spring IoC container: @Component/@Service/@Repository stereotypes, constructor vs field injection, bean scopes, and lifecycle callbacks (@PostConstruct/@PreDestroy)." },
  { id: "spring-rest", title: "Building REST APIs with Spring MVC", category: "Spring Boot", complexity: "Medium", tags: ["spring-mvc", "rest-controller", "request-mapping", "dto", "exception-handling"], description: "Build REST endpoints with @RestController, request/path/query parameter binding, DTO mapping, and centralized error handling with @ControllerAdvice." },
  { id: "spring-data-jpa", title: "Spring Data JPA — Repositories & Query Methods", category: "Spring Boot", complexity: "Medium", tags: ["spring-data-jpa", "repositories", "query-methods", "jpql", "pagination"], description: "Persist data with Spring Data JPA: repository interfaces, derived query methods, custom @Query/JPQL, entity relationships, and pagination/sorting." },
  { id: "spring-security", title: "Spring Security — Authentication & Authorization", category: "Spring Boot", complexity: "Hard", tags: ["spring-security", "authentication", "authorization", "jwt-filter", "method-security"], description: "Secure Spring Boot APIs: configure SecurityFilterChain, JWT-based authentication filters, role-based authorization, and method-level security with @PreAuthorize." },
  { id: "spring-transactions", title: "Transaction Management — @Transactional & Propagation", category: "Spring Boot", complexity: "Hard", tags: ["transactional", "propagation", "isolation-levels", "rollback", "declarative-transactions"], description: "Manage database transactions declaratively with @Transactional: propagation behaviors, isolation levels, rollback rules, and common pitfalls (self-invocation)." },
  { id: "spring-testing", title: "Testing Spring Boot Apps — MockMvc & Testcontainers", category: "Spring Boot", complexity: "Medium", tags: ["spring-boot-test", "mockmvc", "testcontainers", "webmvctest", "datajpatest"], description: "Test Spring Boot layers in isolation with @WebMvcTest/@DataJpaTest and MockMvc, and run realistic integration tests against real databases using Testcontainers." },
  { id: "spring-microservices", title: "Spring Cloud — Microservices, Config Server & Gateway", category: "Spring Boot", complexity: "Hard", tags: ["spring-cloud", "config-server", "spring-cloud-gateway", "service-discovery", "eureka"], description: "Build Spring microservices: centralized configuration with Config Server, service discovery with Eureka, and API routing with Spring Cloud Gateway." },
  { id: "spring-actuator", title: "Spring Boot Actuator — Monitoring & Health Checks", category: "Spring Boot", complexity: "Easy", tags: ["actuator", "health-checks", "metrics", "micrometer", "prometheus"], description: "Expose production-ready monitoring endpoints with Spring Boot Actuator: health checks, custom metrics with Micrometer, and Prometheus integration." },
  { id: "spring-aop", title: "Aspect-Oriented Programming (AOP) in Spring", category: "Spring Boot", complexity: "Hard", tags: ["aop", "aspects", "pointcuts", "advice", "cross-cutting-concerns"], description: "Implement cross-cutting concerns (logging, auditing, caching) with Spring AOP: aspects, pointcut expressions, and advice types (@Before/@After/@Around)." },

  // FastAPI
  { id: "fastapi-fundamentals", title: "FastAPI Fundamentals — Path Operations & Pydantic Models", category: "FastAPI", complexity: "Easy", tags: ["fastapi", "path-operations", "pydantic", "request-body", "openapi"], description: "Build APIs with FastAPI: path/query parameters, Pydantic models for request/response validation, and automatic OpenAPI/Swagger documentation generation." },
  { id: "fastapi-di", title: "Dependency Injection in FastAPI", category: "FastAPI", complexity: "Medium", tags: ["dependency-injection", "depends", "sub-dependencies", "yield-dependencies"], description: "Use FastAPI's Depends system for reusable logic: shared dependencies, sub-dependencies, and yield-based dependencies for setup/teardown (e.g. DB sessions)." },
  { id: "fastapi-async", title: "Async Request Handling & Background Tasks", category: "FastAPI", complexity: "Medium", tags: ["async-def", "background-tasks", "asyncio", "concurrency"], description: "Write high-throughput endpoints with async def handlers, understand when sync vs async matters, and offload work with BackgroundTasks." },
  { id: "fastapi-validation", title: "Request Validation & Pydantic v2 Schemas", category: "FastAPI", complexity: "Medium", tags: ["pydantic-v2", "validators", "response-model", "schema-inheritance"], description: "Validate and serialize data with Pydantic v2: field validators, nested schemas, response_model for output filtering, and schema inheritance patterns." },
  { id: "fastapi-auth", title: "Authentication in FastAPI — OAuth2 & JWT", category: "FastAPI", complexity: "Hard", tags: ["oauth2", "jwt", "security-scopes", "password-hashing", "bearer-token"], description: "Secure FastAPI endpoints with OAuth2 password flow, issue and validate JWT bearer tokens, hash passwords securely, and enforce scope-based permissions." },
  { id: "fastapi-orm", title: "Database Integration — SQLAlchemy & Async ORMs", category: "FastAPI", complexity: "Medium", tags: ["sqlalchemy", "async-orm", "alembic", "sessions", "migrations"], description: "Integrate databases with FastAPI using SQLAlchemy (sync and async engines), manage sessions per request, and version schemas with Alembic migrations." },
  { id: "fastapi-middleware", title: "Middleware, CORS & Exception Handling", category: "FastAPI", complexity: "Medium", tags: ["middleware", "cors", "exception-handlers", "http-exception", "request-lifecycle"], description: "Add cross-cutting behavior with custom middleware, configure CORS for browser clients, and centralize error responses with custom exception handlers." },
  { id: "fastapi-testing", title: "Testing FastAPI — pytest & TestClient", category: "FastAPI", complexity: "Medium", tags: ["pytest", "testclient", "httpx", "dependency-overrides", "fixtures"], description: "Test FastAPI apps with pytest and TestClient/httpx, override dependencies for isolated testing (e.g. mock DB sessions), and structure fixtures for reuse." },
  { id: "fastapi-websockets", title: "WebSockets & Streaming Responses in FastAPI", category: "FastAPI", complexity: "Hard", tags: ["websockets", "streamingresponse", "server-sent-events", "real-time"], description: "Build real-time features with FastAPI WebSockets, stream large responses with StreamingResponse, and implement Server-Sent Events for one-way push updates." },
  { id: "fastapi-deployment", title: "Deploying FastAPI — Uvicorn, Gunicorn & Docker", category: "FastAPI", complexity: "Medium", tags: ["uvicorn", "gunicorn", "docker", "asgi", "production-deployment"], description: "Run FastAPI in production: ASGI servers (Uvicorn workers behind Gunicorn), containerizing with Docker, and configuring health checks/graceful shutdown." },

  // LangChain
  { id: "langchain-fundamentals", title: "LangChain Fundamentals — Chains, Prompts & Models", category: "LangChain", complexity: "Easy", tags: ["langchain", "chains", "prompt-templates", "llm-wrappers"], description: "Learn LangChain's core building blocks: LLM/chat model wrappers, prompt templates, and composing simple chains for structured LLM workflows." },
  { id: "langchain-prompts-parsers", title: "Prompt Templates & Output Parsers", category: "LangChain", complexity: "Medium", tags: ["prompt-engineering", "output-parsers", "structured-output", "few-shot-prompting"], description: "Design reusable, parametrized prompt templates including few-shot examples, and parse raw LLM text into structured objects with output parsers." },
  { id: "langchain-memory", title: "Memory in LangChain — Conversation & Buffer Memory", category: "LangChain", complexity: "Medium", tags: ["memory", "conversation-buffer", "summary-memory", "chat-history"], description: "Give LLM applications conversational context using memory types: buffer memory, summary memory, and windowed memory for managing token limits." },
  { id: "langchain-agents", title: "LangChain Agents & Tool Calling", category: "LangChain", complexity: "Hard", tags: ["agents", "tool-calling", "react-agent", "function-calling"], description: "Build agents that reason and act: the ReAct pattern, defining custom tools, and function/tool calling with modern chat models." },
  { id: "langchain-rag", title: "Retrieval-Augmented Generation (RAG) with LangChain", category: "LangChain", complexity: "Hard", tags: ["rag", "retrieval", "chunking", "embeddings", "context-injection"], description: "Ground LLM responses in your own data with RAG: document chunking strategies, embedding + retrieval, and injecting retrieved context into prompts." },
  { id: "langchain-vectorstores", title: "Vector Stores & Embeddings (FAISS, Pinecone, Chroma)", category: "LangChain", complexity: "Medium", tags: ["vector-store", "embeddings", "faiss", "pinecone", "chroma", "similarity-search"], description: "Store and query embeddings with vector databases: FAISS (local), Pinecone/Chroma (managed), similarity search algorithms, and metadata filtering." },
  { id: "langchain-lcel", title: "LangChain Expression Language (LCEL)", category: "LangChain", complexity: "Medium", tags: ["lcel", "runnables", "pipe-operator", "composability", "streaming"], description: "Compose chains declaratively with LCEL: the Runnable interface, the pipe (|) operator for chaining components, and built-in streaming/batching support." },
  { id: "langchain-document-loaders", title: "Document Loaders & Text Splitters", category: "LangChain", complexity: "Easy", tags: ["document-loaders", "text-splitters", "chunk-overlap", "recursive-splitting"], description: "Ingest data from PDFs, web pages, and databases with document loaders, and split text intelligently with recursive character/token-based splitters." },
  { id: "langchain-evaluation", title: "Evaluating & Debugging LLM Chains (LangSmith)", category: "LangChain", complexity: "Medium", tags: ["langsmith", "evaluation", "tracing", "debugging", "llm-as-judge"], description: "Evaluate and debug LangChain applications with LangSmith: tracing chain execution, dataset-based evaluation, and LLM-as-judge scoring." },
  { id: "langchain-production", title: "Production Patterns — Caching, Streaming & Rate Limits", category: "LangChain", complexity: "Hard", tags: ["caching", "streaming", "rate-limiting", "retries", "cost-optimization"], description: "Harden LangChain apps for production: response caching, token streaming to clients, handling rate limits/retries, and controlling LLM API cost." },

  // LangGraph
  { id: "langgraph-fundamentals", title: "LangGraph Fundamentals — Graphs, Nodes & Edges", category: "LangGraph", complexity: "Easy", tags: ["langgraph", "graph", "nodes", "edges", "state-machine"], description: "Model LLM workflows as graphs: defining nodes (functions/agents), edges (control flow), and how LangGraph generalizes chains into stateful graphs." },
  { id: "langgraph-state", title: "State Management in LangGraph", category: "LangGraph", complexity: "Medium", tags: ["state-schema", "reducers", "typed-state", "state-updates"], description: "Design typed state schemas shared across graph nodes, use reducers to merge partial updates, and manage state evolution through a graph execution." },
  { id: "langgraph-conditional-edges", title: "Conditional Edges & Routing Logic", category: "LangGraph", complexity: "Medium", tags: ["conditional-edges", "routing", "branching", "decision-nodes"], description: "Implement dynamic control flow with conditional edges: routing functions that decide the next node based on current state, and multi-branch decision logic." },
  { id: "langgraph-multi-agent", title: "Building Multi-Agent Systems with LangGraph", category: "LangGraph", complexity: "Hard", tags: ["multi-agent", "supervisor-pattern", "agent-handoff", "orchestration"], description: "Orchestrate multiple specialized agents: supervisor/router patterns, agent-to-agent handoff, and shared state coordination across sub-agents." },
  { id: "langgraph-human-in-loop", title: "Human-in-the-Loop & Interrupts", category: "LangGraph", complexity: "Medium", tags: ["human-in-the-loop", "interrupts", "approval-flow", "breakpoints"], description: "Pause graph execution for human approval or input using interrupts, resume from breakpoints, and design approval workflows for sensitive actions." },
  { id: "langgraph-persistence", title: "Checkpointing & Persistence (Memory Savers)", category: "LangGraph", complexity: "Medium", tags: ["checkpointing", "persistence", "memory-saver", "thread-id", "state-recovery"], description: "Persist graph state across runs with checkpointers, resume conversations by thread ID, and recover from failures without losing execution state." },
  { id: "langgraph-tools", title: "Tool Calling & ReAct Agents in LangGraph", category: "LangGraph", complexity: "Hard", tags: ["tool-calling", "react-pattern", "tool-node", "agent-loop"], description: "Build tool-using agents inside LangGraph: prebuilt ToolNode, the ReAct reasoning-acting loop, and handling tool call errors/retries." },
  { id: "langgraph-streaming", title: "Streaming Outputs & Events in LangGraph", category: "LangGraph", complexity: "Medium", tags: ["streaming", "events", "token-streaming", "graph-events"], description: "Stream intermediate node outputs and token-level LLM output to clients in real time, and subscribe to graph execution events for observability." },
  { id: "langgraph-cyclic-graphs", title: "Cyclic Graphs & Loop Control", category: "LangGraph", complexity: "Hard", tags: ["cycles", "loops", "recursion-limit", "termination-conditions"], description: "Design graphs with cycles for iterative refinement (e.g. self-correction loops), set recursion limits, and define clear termination conditions to avoid infinite loops." },
  { id: "langgraph-deployment", title: "Deploying LangGraph — LangGraph Platform & APIs", category: "LangGraph", complexity: "Medium", tags: ["langgraph-platform", "deployment", "api-server", "scaling"], description: "Deploy LangGraph applications as APIs: LangGraph Platform basics, exposing graphs as HTTP endpoints, and scaling considerations for stateful agent workloads." },
];
